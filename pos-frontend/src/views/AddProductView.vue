    ...
    <div class="max-w-6xl mx-auto space-y-6">
      <form @submit.prevent="handleForm">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h2 class="text-2xl lg:text-3xl font-bold text-text-main dark:text-white tracking-tight">
              Tambah Produk Baru
            </h2>
            <p class="text-text-secondary mt-1">
              Lengkapi formulir di bawah untuk menambahkan item ke inventaris.
            </p>
          </div>
                ...
                >
                  ...
                  >
                    <div class="text-center">
                      <span class="material-symbols-outlined text-white text-4xl mb-2 block">change_circle</span>
